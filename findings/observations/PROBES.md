...
Append to `findings/observations/live-2026-09-09.jsonl`, one per line:
...
```sh
python3 tools/blackbox.py infer  --obs findings/observations/live-2026-09-09.jsonl
python3 tools/blackbox.py design --obs findings/observations/live-2026-09-09.jsonl
```
